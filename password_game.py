...
a="0";languages=[["english","eng"],["russian","ru"]]
...
if lang in languages[0]:
    length="Length";i_p="Enter your password: ";ent_name="Enter your name: "
    ...
    length="Длина";i_p="Введите пароль: ";ent_name="Введите ваше имя: "
